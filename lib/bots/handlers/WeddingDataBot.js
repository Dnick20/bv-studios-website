...
export class WeddingDataBot extends BaseBot {
  ...
  async syncDefaults() {
    ...
    const defaultAddons = [
      { id: 'add_drone', name: 'Drone Coverage', category: 'aerial', price: 30000 },
      { id: 'add_slideshow', name: 'Photo Slideshow', category: 'media', price: 15000 },
      { id: 'add_same_day', name: 'Same Day Edit', category: 'rush', price: 50000 },
      { id: 'add_hours', name: 'Additional Hours', category: 'coverage', price: 20000 },
      { id: 'add_trailer', name: 'Wedding Trailer', category: 'media', price: 25000 },
      { id: 'add_messages', name: 'Guest Messages', category: 'interactive', price: 10000 },
    ]

    const defaultVenues = [
      { name: 'Kentucky Horse Park', location: 'Lexington, KY', address: '4089 Iron Works Pkwy', city: 'Lexington', state: 'KY', zipCode: '40511' },
      { name: 'Gratz Park Inn', location: 'Lexington, KY', address: '120 W 2nd St', city: 'Lexington', state: 'KY', zipCode: '40507' },
      { name: 'Keeneland', location: 'Lexington, KY', address: '4201 Versailles Rd', city: 'Lexington', state: 'KY', zipCode: '40510' },
      { name: 'The Barn at Shaker Village', location: 'Harrodsburg, KY', address: '3501 Lexington Rd', city: 'Harrodsburg', state: 'KY', zipCode: '40330' },
    ]

    const results = { packagesUpserted: 0, addonsUpserted: 0, venuesUpserted: 0 }
