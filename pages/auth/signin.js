...
export default function SignIn() {
  ...
  return (
    <>
      <Head>
        <title>Sign In | BV Studios</title>
        <meta name="description" content="Sign in to your BV Studios account" />
      </Head>
      ...
      <div className="min-h-screen bg-primary flex items-center justify-center">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Professional Video Production</p>
          </div>

          <div className="bg-black/30 backdrop-blur-sm rounded-xl p-8 border border-gray-800">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white mb-2">Welcome Back</h1>
              <p className="text-gray-300">Sign in to your BV Studios account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/20 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent pr-12"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-accent bg-black/20 border-gray-700 rounded focus:ring-accent focus:ring-2"
                  />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 bg-accent text-primary font-semibold rounded-lg hover:bg-accent/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {isLoading ? (
                  <>
